...
class ArticleController
{
    ...
    private function getArticles()
    {
        ...
        try {
            ...
            foreach ($rawArticles as $rawArticle) {
                $articles[] = new Article($rawArticle['id'], $rawArticle['photo'], $rawArticle['title'], $rawArticle['description'], $rawArticle['publish_date'], $rawArticle['author']);
            }
   ...
   public function show($articleId)
    ...
    private function getArticleById($articleId)
    {
        ...
        return new Article($rawArticle['id'], $rawArticle['photo'], $rawArticle['title'], $rawArticle['description'], $rawArticle['publish_date'], $rawArticle['author']);
    }
